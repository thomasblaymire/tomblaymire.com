  ...
  return (
    <>
      ...
      <Grid>
        <PageRow>
          <Col size={12}>
            <div className="flex flex-col max-w-[70rem] mx-auto px-4 tablet:px-0">
              <Button
                onClick={handleBack}
              ...
              >
                <img
                  src={backIcon}
                  alt="Back"
                  className="w-5 h-5 tablet:w-[2.3rem] tablet:h-[2.3rem]"
                />
              </Button>
