...
export function Project({ project }: ProjectProps): JSX.Element {
  ...
  return (
    <li className="box-border p-4 px-2 rounded-[1rem] transition-all duration-[0.4s] ease-in-out tablet:p-4 hover:shadow-[rgb(0_0_0_/_10%)_-1px_10px_19px_0px] hover:bg-[rgba(39,39,42,0.5)]">
      <Link to={`/projects/${slug}`} className="block">
        <div className="bg-[rgb(39,39,42)] border border-[rgba(63,63,70,0.5)] rounded-[50px] justify-center items-center w-[5rem] h-[5rem] flex z-10 right-[8px] relative [&_img]:w-[45px] [&_img]:h-[45px] [&_img]:rounded-[50px]">
          <img
            alt={`${name} logo`}
            src={image}
            decoding="async"
